/*! @azure/msal-node v2.0.2 2023-08-18 */
'use strict';
import { BaseClient, ScopeSet, TokenCacheContext, CacheOutcome, TimeUtils, ResponseHandler, Constants, CredentialType, ClientAuthError, UrlString, RequestParameterBuilder, GrantType, StringUtils, AuthenticationScheme } from '@azure/msal-common';
