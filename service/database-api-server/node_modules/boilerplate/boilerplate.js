...
var moduleFunction = function(args) {
	...
	const conditionStaticFileDb={
		...
		qtools.putSurePath(this.byCondition, pathBits.dir.replace('/','.'), {filename:pathBits.base, urlSegment:urlSegment});

		const cleanSegment=urlSegment.toString().replace('\\/', '/');

		},
		
		getCondition:function(name){
			return this.byCondition[name];
		}
...
console.dir({"condition1":conditionStaticFileDb.getCondition('condition1')});
console.dir({"condition2":conditionStaticFileDb.getCondition('condition2')});
