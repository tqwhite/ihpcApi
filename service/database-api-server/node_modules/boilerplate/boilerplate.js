...
var moduleFunction = function(args) {
	...
	const conditionStaticFileDb = {
		...
		addPath: function(urlSegment) {
			...
			qtools.putSurePath(this.byConditionShortName, pathBits.dir.replace('/', '.'), {
		...
		getCondition: function(name) {
			return this.byConditionShortName[name];
		}
	}
	...
	const getList = (criteria, callback) => {
		...
		Boilerplate.find(criteria, localCallback);
	}
...
boilerplateSchema.virtual('staticFiles').get(function() {  
    return conditionStaticFileDb.byConditionShortName[this.shortName];
});
