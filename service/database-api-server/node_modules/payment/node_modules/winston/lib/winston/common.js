...
Got error about non-existent padLevels and circular dependency. A huge no-comprendo.

This is logging code inside the authorize.net payment kit. I have no patience for debugging it.

I see that the non-existent padLevels should be omitting the setting of levelLenght and
I made it permanent by commenting out the clause. 

That eliminated the error message. As expected, it's all working fine.
