...
var moduleFunction = function(args) {
	...
	const processTransaction = (transaction, callback) => {
		...
		const orderDetails = new ApiContracts.OrderType();
			orderDetails.setInvoiceNumber('IHPC'+user.username+new Date().valueOf().toString().substring(4,13));
		...
		if (processorChoice=='production'){
			qtools.logWarn(`using authorize.net production processor ${SDKConstants.endpoint.production}`);
			qtools.logWarn(`NOTE: call to set production is commented out`);
