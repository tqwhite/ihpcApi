...
shutting down ${__dirname}`);
	...
	const debugDataVersion = 140;

	let debugDataList = [
		{
			NOTE:'user data loading is disabled on line 169',
			NOTE2:'look in project file for basic login info, remember to set ownerRefIds on students for demo',
			refId: 'SAMPLE',
			first: 'nurse2',
			last: 'nurse2_last',
			username: 'nurse2',
	...
	this.initializeDb=(callback)=>{
		...
		if (true || !this.config || !this.config.database || this.config.database.allowReinit != 'true') {
