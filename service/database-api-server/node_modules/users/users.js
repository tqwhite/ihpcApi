...
var moduleFunction = function(args) {
	...
	const confirmEmail = (inData, callback) => {
		const localCallback = (err, result) => {
			...
			if (!result){
				qtools.logError('ERROR! The confirmation URL is incorrect. Perhaps a copy/paste error.');
				callback({
					errorText: 'ERROR! The confirmation URL is incorrect. Perhaps a copy/paste error.'
				});
				return;
			}
...
console.log(`\n=-=============   getAcumentAccountId  ========================= [users.js.moduleFunction]\n`);
	...
	const getUrlToken = (criteria, type, callback) => {
		if (!['forgotPasswordToken', 'emailConfirmationToken', 'acumenAccountId'].includes(type)) {
