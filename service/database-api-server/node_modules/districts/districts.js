...
var moduleFunction = function(args) {
	...
	const getAllDistricts = (query={}, callback) => {
		const localCallback = (err, result) => {
			callback(err, result);
		};
	...
	const getDistrictByRefId = ({ refId, callback }) => {
		const localCallback = (err, result) => {
			callback(err, result);
		};
	...
	this.apiManager.registerApi('getDistrictByRefId', getDistrictByRefId); //databaseApiServer.bookNumbers.users.session.boilerplate.payment.transfer.students.districts.getDistrictByRefId
	this.apiManager.registerApi('getAllDistricts', getAllDistricts); //databaseApiServer.bookNumbers.users.session.boilerplate.payment.transfer.students.districts.getDistrictByRefId



this.apiManager.list();
