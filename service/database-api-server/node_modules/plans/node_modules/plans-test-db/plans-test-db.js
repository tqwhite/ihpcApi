	...
	const sourceList = [
		{
			...
			conditions:[{
				...
				diagnoses:[{
					...
					assessment: 'ad.1.1.1 assessment',
				...
				diagnoses:[{
					refId: 'ad.2.1.1',
					sourceDiagnosisRefId: null,
					assessment: 'ad.2.1.1 assessment',
		...
		},
		{
			...
			conditions:[{
				...
				diagnoses:[{
					refId: 'ad2.2.1.1',
					sourceDiagnosisRefId: null,
					assessment: 'ad2.2.1.1 assessment',
